...
/**
 * finds_biggest - finds the biggest number of a username string
 *
 * @username: username
 * @len: length of username
 * Return: the biggest number
 */
int finds_biggest(char *username, int len)
{
	int ch;
	int vch;
 ...
 */
int square_chars_username(char *username, int len)
{
	int ch;
	int vch;
...
int main(int argc, char **argv)
{
	...
	keygen[3] = ((char *)alph)[finds_biggest(argv[1], len)];
	keygen[4] = ((char *)alph)[square_chars_username(argv[1], len)];
